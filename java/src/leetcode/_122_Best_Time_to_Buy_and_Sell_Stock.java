...
public class _122_Best_Time_to_Buy_and_Sell_Stock {
  ...
  /**
   * This leetcode follows the logic used in Approach 2 itself, but with only a slight variation. In
   ...
   * approach will simplify the leetcode. This can be made clearer by taking this example:
   */
