...
/**
 * Pinic porblem: kindergarten is going to hold a picnic event, two students will be grouped
 * together, however, not every student are friends with each other, and only students are knew each
...
public class Picnic {
  ...
  private void backtrack(List<List<int[]>> acc, ArrayList<int[]> tempList, boolean[] picked,
      int start, int[][] pair) {
  ...
  public static void main(String[] args) {
    ...
    int[][] pair2 = new int[][]{{0, 1}, {0, 2}, {1, 2}, {1, 3}, {1, 4}, {2, 3}, {2, 4}, {3, 4},
        {3, 5}, {4, 5}};
