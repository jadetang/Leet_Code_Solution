...
/**
 * @author sanguan.tangsicheng on 2017/7/2 下午4:38
 */
public class _134_Gas_Station {
     ...
     * In the mean time, add up all of the left gas to total. If it's negative finally, return -1 since it's impossible
     * to finish.
