...
public class _403_Frog_Jump {
  ...
  public static class State {
    ...
    public boolean equals(Object that) {
      ...
      return this.step == other.step && this.pos == other.pos;
    }
  ...
  public boolean canCross(int[] stones) {
    ...
    list.add(firstState);
    while (!list.isEmpty()) {
      State current = list.poll();
      if (current.pos == stones[stones.length - 1]) {
        return true;
      } else {
        for (int i = current.step - 1; i <= current.step + 1; i++) {
          if (i > 0 && stoneSet.contains(current.pos + i) && !visited
              .contains(new State(current.pos + i, i))) {
            visited.add(new State(current.pos + i, i));
            list.offer(new State(current.pos + i, i));
          }
        }
      }
    }
  ...
  public static void main(String[] args) {
    _403_Frog_Jump frog_jump = new _403_Frog_Jump();
    System.out.println(frog_jump.canCross(new int[]{0, 1, 3, 5, 6, 8, 12, 17}));
    System.out.println(frog_jump.canCross(new int[]{0, 1, 2, 3, 4, 8, 9, 11}));
    System.out.println(frog_jump.canCross(
